package io.jiangbyte.app.biz.cart.entity;
...
@Data
@TableName(value = "biz_cart", autoResultMap = true)
@Schema(name = "BizCart", description = "购物车表")
public class BizCart extends BaseEntity {
    @Serial
