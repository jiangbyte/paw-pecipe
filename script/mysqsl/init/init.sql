...
VALUES ('1', '网站配置', 'WEBSITE', '网站基础信息配置', 1, TRUE, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
VALUES
    -- 网站信息
    ('1', 'WEBSITE', '网站名称', 'WEBSITE_NAME', 'Galaxy 内容管理系统', 'input', '网站的名称', 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
    ('2', 'WEBSITE', '网站Logo', 'WEBSITE_LOGO', '/static/images/logo.png', 'upload', '网站的Logo图片路径', 2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
    ('3', 'WEBSITE', '网站描述', 'WEBSITE_DESCRIPTION', '一个现代化的内容管理系统，基于 Go 语言开发', 'textarea', '网站的简要描述', 3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
    ('4', 'WEBSITE', '网站关键字', 'WEBSITE_KEYWORDS', 'CMS,内容管理,Go,Golang,Galaxy', 'input', '网站SEO关键字，用逗号分隔', 4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
    ('5', 'WEBSITE', '网站作者', 'WEBSITE_AUTHOR', 'Galaxy Team', 'input', '网站的作者或开发团队', 5, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
    ('6', 'WEBSITE', '版权信息', 'WEBSITE_COPYRIGHT', '© 2025 Galaxy CMS. All Rights Reserved.', 'input', '网站版权信息', 6, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
    ('7', 'WEBSITE', '网站版本', 'WEBSITE_VERSION', '1.1.0', 'input', '网站的版本号', 7, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),

    -- 联系信息
    ('8', 'WEBSITE', 'QQ联系方式', 'CONTACT_QQ', '', 'input', 'QQ联系方式', 8, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
    ('9', 'WEBSITE', '联系邮箱', 'CONTACT_EMAIL', 'contact@galaxy-cms.com', 'input', '网站联系邮箱', 9, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
    ('10', 'WEBSITE', '微信联系方式', 'CONTACT_WECHAT', '', 'input', '微信联系方式', 10, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),

    -- 社交链接
    ('11', 'WEBSITE', '社交媒体链接', 'SOCIAL_LINKS', '[{"image": "/static/images/github.png", "title": "GitHub", "url": "https://github.com/galaxy-cms"}]', 'json-editor', '社交媒体链接配置，JSON格式', 11, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());



-- 插入默认菜单数据
insert into sys_menu (id, pid, name, path, component_path, redirect, external_url, menu_type, open_target, iframe_attrs, title, icon, sort, keep_alive, visible, pined, without_tab, parameters, extra_params, is_deleted, deleted_at, deleted_by, created_at, created_by, updated_at, updated_by)
values  ('1', '0', 'dashboard', '/dashboard', '/dashboard/index.vue', null, null, 0, 0, null, '仪表盘', 'dashboard', 1, true, true, false, false, null, null, false, null, null, '2025-11-19 02:41:46.956364', null, '2025-11-19 02:41:46.956364', null),
        ...
        ('25', '24', '404', '/code/404', '/code/404.vue', null, null, 0, 0, null, '404页面', 'file-unkCURRENT_TIMESTAMPn', 1, false, true, false, false, null, null, false, null, null, '2025-11-19 02:41:46.956364', null, '2025-11-19 02:41:46.956364', null),
...
-- 插入默认角色数据
INSERT INTO auths_role (id, name, code, data_scope, description, created_at, updated_at)
VALUES ('1', '超级管理员', 'SUPER_ADMIN', 'ALL', '系统超级管理员，拥有所有权限', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       ('2', '系统管理员', 'ADMIN', 'GROUP_AND_CHILD', '系统管理员，拥有大部分管理权限', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       ('3', '部门管理员', 'GROUP_ADMIN', 'GROUP', '部门管理员，管理本部门用户和权限', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       ('4', '普通用户', 'USER', 'SELF', '普通用户，只能查看和操作自己的数据', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
-- 定义常量并插入数据
-- 定义常量并插入数据
SET @common_password = '$2a$10$eE2quG/tVgyPBeHfA7EQyOYBd36hpxBEVK6wh/HdAV9Nd9Wh.MjGi';
SET @common_avatar = 'https://ts1.tc.mm.bing.net/th/id/R-C.6a6d08e2769800fe626bdf3ccbd7b2bf?rik=f2hCf09zz%2f9k3w&riu=http%3a%2f%2fpic.imeitou.com%2fuploads%2fallimg%2f240318%2f10-24031Q62553.jpg&ehk=xiruSwoAcF8DeN%2bzMk5g%2bRv%2baNwdPsxj4YUV4CLEe2A%3d&risl=&pid=ImgRaw&r=0';

-- ============= 超级管理员 =============
-- 插入默认用户数据
INSERT INTO auths_account (id, username, password, email, created_at, updated_at)
VALUES ('1', 'superadmin', @common_password, 'jiangbyte@163.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
-- 插入用户信息
INSERT INTO users_info (id, account_id, nickname, avatar, created_at, updated_at)
VALUES ('1', '1', '超级管理员', @common_avatar, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
-- 插入用户档案
INSERT INTO users_profile (id, account_id, created_at, updated_at)
VALUES ('1', '1', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
-- 插入用户偏好设置
INSERT INTO users_preference (id, account_id, created_at, updated_at)
VALUES ('1', '1', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
-- 插入用户统计
INSERT INTO users_stats (id, account_id, created_at, updated_at)
VALUES ('1', '1', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
-- 插入用户角色关联
INSERT INTO auths_account_role (id, account_id, role_id)
VALUES ('1', '1', '1');

-- ============= 系统管理员 =============
INSERT INTO auths_account (id, username, password, email, created_at, updated_at)
VALUES ('2', 'admin', @common_password, 'admin@company.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_info (id, account_id, nickname, avatar, created_at, updated_at)
VALUES ('2', '2', '系统管理员', @common_avatar, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_profile (id, account_id, created_at, updated_at)
...
-- ============= 部门管理员 =============
INSERT INTO auths_account (id, username, password, email, created_at, updated_at)
VALUES ('3', 'deptadmin', @common_password, 'dept_admin@company.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_info (id, account_id, nickname, avatar, created_at, updated_at)
VALUES ('3', '3', '技术部经理', @common_avatar, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_profile (id, account_id, created_at, updated_at)
...
-- 用户4
INSERT INTO auths_account (id, username, password, email, created_at, updated_at)
VALUES ('4', 'zhangsan', @common_password, 'zhangsan@company.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_info (id, account_id, nickname, avatar, created_at, updated_at)
VALUES ('4', '4', '张三', @common_avatar, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_profile (id, account_id, created_at, updated_at)
...
-- 用户5
INSERT INTO auths_account (id, username, password, email, created_at, updated_at)
VALUES ('5', 'lisi', @common_password, 'lisi@company.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_info (id, account_id, nickname, avatar, created_at, updated_at)
VALUES ('5', '5', '李四', @common_avatar, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_profile (id, account_id, created_at, updated_at)
...
-- 用户6
INSERT INTO auths_account (id, username, password, email, created_at, updated_at)
VALUES ('6', 'wangwu', @common_password, 'wangwu@company.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_info (id, account_id, nickname, avatar, created_at, updated_at)
VALUES ('6', '6', '王五', @common_avatar, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_profile (id, account_id, created_at, updated_at)
...
-- 用户7
INSERT INTO auths_account (id, username, password, email, created_at, updated_at)
VALUES ('7', 'zhaoliu', @common_password, 'zhaoliu@company.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_info (id, account_id, nickname, avatar, created_at, updated_at)
VALUES ('7', '7', '赵六', @common_avatar, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_profile (id, account_id, created_at, updated_at)
VALUES ('7', '7', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_preference (id, account_id, created_at, updated_at)
VALUES ('7', '7', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_stats (id, account_id, created_at, updated_at)
VALUES ('7', '7', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
-- 用户8
INSERT INTO auths_account (id, username, password, email, created_at, updated_at)
VALUES ('8', 'sunqi', @common_password, 'sunqi@company.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_info (id, account_id, nickname, avatar, created_at, updated_at)
VALUES ('8', '8', '孙七', @common_avatar, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_profile (id, account_id, created_at, updated_at)
VALUES ('8', '8', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_preference (id, account_id, created_at, updated_at)
VALUES ('8', '8', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO users_stats (id, account_id, created_at, updated_at)
VALUES ('8', '8', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
